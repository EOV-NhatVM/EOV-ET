...
import xarray as xr
from pywapor_folder.enhancers.smooth.whittaker import whittaker, cross_val_lmbda, second_order_diff_matrix, cve1, cve2, whittaker_smoothing
from pywapor_folder.enhancers.smooth.core import wt1, wt2
import pandas as pd
import os
import itertools
...
if __name__ == "__main__":
    ...
    ts_fp = os.path.join(pywapor_folder.__path__[0], "enhancers", "smooth", "input_test_series.nc")

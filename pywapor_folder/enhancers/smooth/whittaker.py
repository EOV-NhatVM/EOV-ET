import xarray as xr
import numpy as np
from pywapor_folder.general.processing_functions import save_ds, open_ds
from pywapor_folder.enhancers.smooth.plotters import make_overview
from pywapor_folder.general.logger import log

def xr_dist_to_finite(y, dim = "time"):

    from pywapor_folder.enhancers.smooth.core import dist_to_finite
...
def xr_choose_func(y, lmbdas, dim):
    ...
    from pywapor_folder.enhancers.smooth.core import _wt1, _wt2
...
def xr_cve(y, x, lmbdas, u):
    ...
    from pywapor_folder.enhancers.smooth.core import second_order_diff_matrix, cve1
...
def xr_wt(y, x, lmbdas, u = None, a = 0.5, min_drange = -np.inf, 
    ...
    from pywapor_folder.enhancers.smooth.core import second_order_diff_matrix
...
if __name__ == "__main__":
    ...
    import matplotlib.pyplot as plt
    from pywapor_folder.enhancers.smooth.plotters import plot_point

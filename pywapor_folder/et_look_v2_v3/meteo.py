...
"""
from pywapor_folder.et_look_v2_v3 import constants as c
import numpy as np
import xarray as xr
...
def wind_speed_blending_height_daily(u_24, z_obs=2, z_b=100):
    ...
    """
    if u_24 is None or (hasattr(u_24, "values") and np.all(np.isnan(u_24.values))):
        print("u_24 is None or contains only NaNs.")
        return None

...
import os
import json
import pywapor_folder.collect
import xarray as xr
from pywapor_folder.general.processing_functions import open_ds
...
def tiles_intersect(latlim, lonlim):
    ...
    """
    with open(os.path.join(pywapor_folder.collect.__path__[0], "product/SRTM30_tiles.geojson")) as f:

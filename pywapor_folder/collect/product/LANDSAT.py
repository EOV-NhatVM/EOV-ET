...
from pywapor_folder.general.processing_functions import open_ds, save_ds, remove_ds, adjust_timelim_dtype, make_example_ds
from pywapor_folder.collect.protocol.crawler import download_urls
from pywapor_folder.enhancers.apply_enhancers import apply_enhancer, apply_enhancers
from pywapor_folder.enhancers.gap_fill import gap_fill
import xmltodict
...
def request_scenes(ids, image_extents):
    ...
    uauth = pywapor_folder.collect.accounts.get("EARTHEXPLORER") 
    ...
    order['note'] = f'pyWaPOR_{pywapor_folder.__version__}'

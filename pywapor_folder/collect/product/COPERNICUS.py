...
from pywapor_folder.collect.protocol import cog
from functools import partial
from pywapor_folder.general.processing_functions import open_ds, save_ds, remove_ds
from pywapor_folder.enhancers.apply_enhancers import apply_enhancers
from pywapor_folder.enhancers.dem import calc_slope_or_aspect
...
def tiles_intersect(latlim, lonlim, product_name):
    ...
    """
    with open(os.path.join(pywapor_folder.collect.__path__[0], f"product/{product_name}.txt")) as src:
